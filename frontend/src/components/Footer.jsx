    ...
    <footer className="font-inter w-full border-t border-[#2a2d35] bg-[#20222C]">
      ...
      <div className="grid w-full grid-cols-1 items-start gap-[32px] px-[clamp(1rem,3vw,40px)] pb-[32px] pt-[48px] lg:grid-cols-[2fr_1fr_1fr_1fr_auto]">
        ...
        <div className="flex flex-col">
          ...
          {["Fonctionnalités", "Matchmaking", "Tarifs", "API"].map(item => (
            <a key={item} className="mb-[18px] block cursor-pointer text-[14px] font-normal text-[#9ca3af] transition-colors duration-200 hover:text-[#FF540B]">{item}</a>
          ))}
        </div>
        ...
        <div className="flex flex-col items-start sm:items-start lg:items-end lg:justify-self-end">
          ...
          <div className="flex flex-col items-start gap-[14px] lg:items-center">
            ...
            <div className="flex items-center gap-[8px]">
              {/* Facebook */}
              <button
                className="flex h-[44px] w-[44px] cursor-pointer items-center justify-center rounded-[10px] border-[1.5px] border-[#ff540b96] bg-transparent transition-[border-color,background] duration-200 hover:border-[#FF540B] hover:bg-[rgba(255,84,11,0.10)]"
                aria-label="Facebook"
                onClick={() => window.open("https://www.facebook.com", "_blank")}
              >
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="text-[#9ca3af]">
              ...
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="text-[#9ca3af]">
      ...
      <div className="flex justify-center border-t border-[#2a2d35] px-[clamp(1rem,3vw,40px)] py-[18px]">
        <p className="text-[13px] text-[#6b7280]">© 2026 - MatchHub. Tous droits réservés.</p>
      </div>
    </footer>
  );
}
